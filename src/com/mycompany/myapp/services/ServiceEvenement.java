...
public class ServiceEvenement {
    ...
    public boolean addEvenement(Evenement l) {
        String url = Statics.BASE_URL + "/evenement/Addjson?titre=" + l.getTitre() + "&description=" + l.getDescription() + "&nomss=" + l.getNomss() ;
        req.setUrl(url);
        req.setPost(false);
...
String url = Statics.BASE_URL + "/evenement/updateEventJSON/" + l.getIde() + "?titre=" + l.getTitre() + "&description=" + l.getDescription() + "&nomss=" + l.getNomss() ;
       // req.setUrl(url);
    req.setUrl(url);

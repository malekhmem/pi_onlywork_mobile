...
public class Servicereclamation {
    ...
    public static Servicereclamation getInstance() {
     ...
     public boolean addreclamation(reclamation r) {
        String url = Statics.BASE_URL + "/en/reclamation/Addjsonr/new?descr=" + r.getDescr() + "&nomr=" + r.getNomr() + "&emailr=" + r.getEmailr() + "&type=" + r.getType();
        req.setUrl(url);
        req.setPost(false);
...
public ArrayList<reclamation> parseReclamations(String jsonText) {
    ...
    public ArrayList<reclamation> getAllreclamation() {
       String url = Statics.BASE_URL + "/en/reclamation/Allreclamation";
...
public boolean deleteAnnoncef(int idr) {
    String url = Statics.BASE_URL + "/en/reclamation/deletereclamation/" + idr;
...
public boolean modifierAnnoncef(reclamation r){
        ...
        String url = Statics.BASE_URL + "/en/reclamation/updatereclamation/" + r.getIdr() + "?descr=" + r.getDescr() +"&nomr=" + r.getNomr() + "&emailr=" + r.getEmailr() + "&type=" + r.getType();
       // req.setUrl(url);
    req.setUrl(url);
